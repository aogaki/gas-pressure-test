...
- 座標変換 (pads.csv のヘッダに記載): x_sim = x_det、z_sim = −250 + d + (48.930 − y_det)、d = 入射窓からパッド上流端までの距離 [mm]。テストは d = 0 (geometry/pads.csv)。241Am 線源の配置 (線源からパッド上流端まで約 50 mm) は d = 50 の geometry/pads_d50.csv で扱う (TODO/08)
